...
export default function Connections() {
  ...
  return (
<div className="mx-auto mt-10 w-full max-w-md bg-base-300 rounded-2xl shadow-md p-3 sm:p-4">
  ...
  {loading ? (
    ...
    <div className="space-y-6 overflow-y-auto pr-2"
         style={{ maxHeight: '60vh' }}> {/* 👈 You can adjust this */}
        ...
        >
          ...
          <div className="hidden group-hover:flex gap-2 flex-wrap justify-center sm:justify-end w-full sm:w-auto">
            <Link to={`/chat/${conn._id}`}>
              <button className="btn btn-xs btn-accent text-white">Message</button>
            </Link>
